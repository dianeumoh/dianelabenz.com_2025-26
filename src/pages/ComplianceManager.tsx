          ...
          <aside className="meta-stack">
            ...
            <div className="meta-block">
              ...
              <div className="meta-links">
                <a href="https://cloud.google.com/blog/products/identity-security/streamline-auditing-compliance-manager-is-now-in-preview" className="footer-external-link">Product website<ArrowIcon /></a>
                <a href="https://www.crn.com/news/security/2025/5-big-google-cloud-security-announcements-at-next-2025" className="footer-external-link">CRN Magazine<ArrowIcon /></a>
                <a href="https://youtu.be/r4nol-bJsxw" className="footer-external-link">Google Cloud Next<ArrowIcon /></a>
              </div>
            </div>
...
/>
          ...
          <p>Customers couldn't easily monitor their compliance posture, identify and remediate issues, or prepare for audits. Leadership planned to solve the fragmentation by mandating the integration of these two products, Assured Workloads and Security Command Center, into one another.</p>
...
/>
      ...
      <AnimateOnScroll>
        <CSSection>
          ...
          <p>Months before the mandate to integrate Assured Workloads into Security Command Center, I had already initiated and led a study investigating why Assured Workloads adoption was stalling, even amongst customers with <i>free</i> access.</p>
          <p><strong>I uncovered that:</strong></p>
        </CSSection>
      </AnimateOnScroll>
    ...
    <CSCard 
      ...
      description="Compliance teams needed to prove compliance daily to auditors. They needed to see their status, identify gaps, and get actionable next steps; but our tool only showed violations after they occurred."
    />
    <CSCard 
      variant="standard"
      icon="😵‍💫"
      title="Achieving compliance was too hard"
      description="Customers couldn't map compliance requirements (called 'controls') to the approprite Google Cloud policies. Without this visibility, they couldn't trust the system or take action confidently."
    />
  </CSGrid>
  ...
  <AnimateOnScroll>
    <CSSection>
      ...
      <h2>I used data to shift our strategy to a truly unified experience</h2>
      <p>To minimize disruption to their existing roadmap, the team's default approach was a "lift-and-shift" strategy that would move the existing Assured Workloads experience into SCC with minimal changes.</p>
      <p>Based on the research I led, I knew this wouldn't work. Simply moving the experience wouldn't solve the core problems customers were facing. I partnered with the SCC UX lead to create a vision prototype that demonstrated a phased path to real integration.</p>
      <p>My research informed a roadmap that included:</p>
      <ol>
  ...
  <CSSection>
    <p>The SCC UX lead and I presented the strategy to a small working group of PM and engineering leads. The team had concerns about timeline and resources, but saw the feasibility of a phased approach. After more discussion, our team decided to make our case to senior leadership for dedicated time and resources.</p>
  ...
  <CSSection>
    ...
    <CSImageGroup
        ...
        <AnimateOnScroll>
        <CSSection>
          <p><strong>Outcome:</strong> ✅ <i>Validated</i></p>
          <p>8/10 participants saw value in predicted scores. However, delivering truly personalized recommendations based on each customer's environment wasn't technically feasible for the MVP. Rather than ship a generic AI experience that would erode trust, I deprioritized AI features and focused on deterministic, auditable scoring that compliance teams could show to regulators.</p>
        </CSSection>
        </AnimateOnScroll>
        <AnimateOnScroll>
          <CSSection>
            <h4>Sprint #2: Near-term experience</h4>
            <p>I applied Sprint 1 learnings to improve transparency and guidance in the near-term MVP. Another adoption barrier was the lack of visibility between regulatory requirements (controls) and the Google Cloud policies that achieve those requirements.</p>
      ...
      description="Controls (Compliance requirements) are the cloud-agnostic way compliance teams measure compliance. An experience without this is like Google Maps without the turn-by-turn directions. For public sector customers, this was table stakes. Without it, we couldn't demonstrate we understood compliance workflows."
    />
          </CSSection>
        </AnimateOnScroll>
        <AnimateOnScroll>
            ...
            images={[
              { 
                ...
                annotations: [
                  ...
                  "2. 'View by controls or policies': Allows compliance teams to work in 'controls' (what auditors care about) while letting engineers work in 'policies' (what they implement), creating a single source of truth for both."
                ]
              },
            ]}
            backgroundColor="var(--color-gradient-tertiary)"
        ...
        <AnimateOnScroll>
          <CSSection>
            <p><strong>Outcome:</strong> ✅ <em>Validated</em></p>
            <p>The "controls-first" view tested with 100% positive sentiment for all participants: </p>
            <CSBlockquote variant="accent">
        ...
        <AnimateOnScroll>
          <CSSection>
            <h3>Build</h3>
            <h2>From 0 to MVP: Designing key capabilities that transformed a broken journey into a unified experience</h2>
            ...
            <p>I designed the full end-to-end experience of our core capabilities:</p>
        ...
        <AnimateOnScroll>
          <CSSection>
            <h4>2. Custom framework builder</h4>
        ...
        <AnimateOnScroll>
          <CSSection>
            <h4>3. Cloud controls (new policy management experience)</h4>
            ...
            <p><strong>The solution:</strong> With cloud controls, customers no longer have to interface with various rules and policies. Instead, cloud controls act as a “wrapper” around existing rules supporting our customers on their journey from issue detection to prevention.</p>
          </CSSection>
        </AnimateOnScroll>
        <AnimateOnScroll>
          <CSImageGroup
        ...
        <AnimateOnScroll>
          <CSSection>
            ...
            <p>Customers explicitly requested "Mute & Risk Accept" to reduce noise from irrelevant findings, critical for mitigating alarm fatigue. Unfortunately, we couldn't build it for the MVP. Additionally, we were under pressure to ship the feature quickly which meant I needed to design pragmatic solutions that worked within these constraints.</p>
        ...
        <AnimateOnScroll>
          ...
          <AnimateOnScroll>
            <CSSection>
              <h4>5. Framework monitoring detail page</h4>
              <p><strong>The problem:</strong> Our old experience didn't provide a way to see the details of a framework, which customers needed to understand which compliance requirements (controls) were being monitored and which Google Cloud policies were applied.</p>
        ...
        <AnimateOnScroll>
          <CSSection>
            ...
            <ol>
              ...
              <li><strong>2. The aggregation:</strong> Controls don't have findings, but policies do. I needed to show aggregated pass/fail indicators at the parent level</li>
        ...
        <AnimateOnScroll>
          <CSSection>
            ...
            <CSCard 
              ...
              description="in at-risk public sector pipeline deals (customers evaluating multi-cloud solutions cited unified compliance management as a requirement)"
            />
            <CSCard 
              variant="standard"
              icon=""
            ...
            <CSSection>
              <p>The product was featured at Google Cloud Next 2025, showcasing the unified compliance journey to thousands of customers and partners.</p>
        ...
        <AnimateOnScroll>
          <CSGrid>
            <CSCard
              ...
              title="What worked:"
              description="The sprint approach allowed us to explore big ideas (like AI-powered recommendations), validate assumptions quickly, and build stakeholder confidence through customer evidence rather than opinion. Deprioritizing AI when it wasn't feasible prevented us from shipping an experience that would have damaged trust with compliance teams."
            />
            <CSCard
              variant="sketchy"
              icon=<img src="src/images/learned_icon.svg" alt="Open book" />
              title="What I learned:"
              description="A senior designer's job isn't just to solve the problems they're given. It's to find the right problems to solve. The team thought we had a pricing or marketing problem. My research proved it was a core product value problem. That insight became the catalyst for the entire $275M success."
            />
            <CSCard
              variant="sketchy"
              icon=<img src="src/images/differently_icon.svg" alt="Pencil eraser" />
              title="What I'd change:"
              description="I wish I had advocated earlier for intentional Infrastructure as Code (IaC) support. Tools like Terraform are critical for many Google Cloud users, and while I kept this in mind throughout the design process and embedded support where I could, I should have pushed harder to make IaC a first-class consideration from day one, not just a UI afterthought."
            />
          </CSGrid>
        </AnimateOnScroll>
